...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        posterGridView =findViewById(R.id.posters_gv);
    ...
    public void showPop() {
        ...
        save =sortDialog.findViewById(R.id.save_btn);
        radioGroup =sortDialog.findViewById(R.id.radio_group);
        cancel =sortDialog.findViewById(R.id.cancel_button);
